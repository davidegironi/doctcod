...
namespace DG.DoctcoD.Helpers.Test
{
    ...
    public partial class DoctcoDHelpersTest
    {
        ...
        public void CleanDir_CleanPatientDir()
        {
            ...
            _doctcodModel.Patients.Remove(_doctcodModel.Patients.List(r => r.patients_name == "XX2" && r.patients_surname == "XX2").ToArray());
            ...
            _doctcodModel.Patients.Add(t_patients1);
            ...
            _doctcodModel.Patients.Add(t_patients2);
        ...
        public void CleanDir_CleanPatientAttachmentsDir()
        {
            ...
            _doctcodModel.PatientsAttachments.Add(t_patientsattachments1);
            ...
            _doctcodModel.PatientsAttachments.Add(t_patientsattachments2);
            ...
            _doctcodModel.PatientsAttachments.Update(t_patientsattachments2);
            ...
            _doctcodModel.PatientsAttachments.Update(t_patientsattachments1);
