...
namespace DG.DoctcoD.Model.Entity
{
    ...
    public partial class doctcodEntities : DbContext
    {
        public doctcodEntities()
            : base("name=doctcodEntities")
        {
        }
        ...
        public virtual DbSet<descriptiontemplatestreatments> descriptiontemplatestreatments { get; set; }
