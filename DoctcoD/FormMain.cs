...
namespace DG.DoctcoD
{
    public partial class FormMain : DGUIGHFFormMain
    {
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                DoctcoDModel doctcodModel = new DoctcoDModel();
                doctcodModel.Doctors.Find(-1);
            }
            catch
            {
        ...
        public override void AddLanguageComponents()
        {
            ...
            LanguageHelper.AddComponent(descriptionTemplatesTreatmentsToolStripMenuItem);
        ...
        public override void SetAdditionalLanguage()
        {
            ...
            DoctcoDModel doctcodModel = new DoctcoDModel();
            doctcodModel.LanguageHelper.LoadFromFile(Program.uighfApplication.LanguageFilename);
            LanguageHelper.AddAdditionalLanguage(doctcodModel.LanguageHelper.Get());
        ...
        /// <summary>
        /// DescriptiontemplatesTreatments form
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void descriptionTemplatesTreatmentsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowFormProtected(this, typeof(FormDescriptiontemplatesTreatments));
        }
