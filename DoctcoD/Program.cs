    ...
    static class Program
    {
        ...
        public static DGUIGHFApplication uighfApplication = new DGUIGHFApplication(
            new DGUIGHFApplication.DGUIGHFApplicationConfig
            {
                ...
                stackTracerSenderFrom = "DoctcoD",
                appWeblink = "https://github.com/davidegironi/doctcod",
                languageFolder = "lang",
                language = ConfigurationManager.AppSettings["language"],
                aboutLogo = new Bitmap(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("DG.DoctcoD.about_logoimg.png")),
                splashScreenLogo = new Bitmap(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("DG.DoctcoD.splashscreen_logo.png"))
            });
