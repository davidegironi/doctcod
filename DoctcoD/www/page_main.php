...
<head>
  ...
  <meta name="description" content="DoctcoD web app">
  <meta property="og:description" content="DoctcoD web app" />
...
<?php if($login->isLoggedIn) { ?>
            <li><a href="?"><?php echo $lang['MENU_CALENDAR']; ?></a></li>
<?php if($login->userType == 'D') { ?>
            <li><a href="?page=patientstreatments"><?php echo $lang['MENU_PATIENTSTREATMENTS']; ?></a></li>
<?php } ?>
<?php } ?> 
          </ul>
...
<?php } else {
        if(isset($_GET['page']) && $_GET['page'] == 'patientstreatments') {
          include('page_patientstreatments.php');
        } else {
          include('page_calendar.php');
        }
      } ?>
  ...
  <div id="footer">
    <div class="container">
      <p class="muted credit">Powered by <a href="https://github.com/davidegironi/doctcod"><b>DoctcoD</b></a>.</p>
    </div>
  </div>
