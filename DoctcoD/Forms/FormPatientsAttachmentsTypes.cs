    ...
    public partial class FormPatientsAttachmentsTypes : DGUIGHFForm
    {
            ...
            EnhancedComboBoxHelper.AttachComboBox(
                ...
                new EnhancedComboBoxHelper.Items[] {
                    new EnhancedComboBoxHelper.Items()
                    {
                        ...
                        _value = _doctcodModel.PatientsAttachmentsTypes.language.valueAutoFuncNUL,
                        _values = new string[]
                        {
                            _doctcodModel.PatientsAttachmentsTypes.language.valueAutoFuncNUL
                        }
                    },
                    new EnhancedComboBoxHelper.Items()
                    {
                        _id = PatientsAttachmentsTypesRepository.ValueAutoFuncCode.AMG.ToString(),
                        _value = _doctcodModel.PatientsAttachmentsTypes.language.valueAutoFuncAMG,
                        _values = new string[]
                        {
                            _doctcodModel.PatientsAttachmentsTypes.language.valueAutoFuncAMG
                        }
                    },
                    new EnhancedComboBoxHelper.Items()
                    {
                        _id = PatientsAttachmentsTypesRepository.ValueAutoFuncCode.AML.ToString(),
                        _value = _doctcodModel.PatientsAttachmentsTypes.language.valueAutoFuncAML,
                        _values = new string[]
                        {
                            _doctcodModel.PatientsAttachmentsTypes.language.valueAutoFuncAML
                        }
                    },
                    new EnhancedComboBoxHelper.Items()
                    {
                        _id = PatientsAttachmentsTypesRepository.ValueAutoFuncCode.AMD.ToString(),
                        _value = _doctcodModel.PatientsAttachmentsTypes.language.valueAutoFuncAMD,
                        _values = new string[]
                        {
                            _doctcodModel.PatientsAttachmentsTypes.language.valueAutoFuncAMD
                        }
                    }
                }.ToArray());
        ...
        private object GetDataSource_main()
        {
            IEnumerable<VPatientsAttachmentsTypes> vPatientsAttachmentsTypes =
                _doctcodModel.PatientsAttachmentsTypes.List().Select(
        ...
        {
            return DGUIGHFData.LoadEntityFromCurrentBindingSource<patientsattachmentstypes, DoctcoDModel>(_doctcodModel.PatientsAttachmentsTypes, vPatientsAttachmentsTypesBindingSource, new string[] { "patientsattachmentstypes_id" });
        }
        ...
        {
            DGUIGHFData.SetBindingSourcePosition<patientsattachmentstypes, DoctcoDModel>(_doctcodModel.PatientsAttachmentsTypes, item, vPatientsAttachmentsTypesBindingSource);
        }
        ...
        {
            DGUIGHFData.Add<patientsattachmentstypes, DoctcoDModel>(_doctcodModel.PatientsAttachmentsTypes, item);
        }
        ...
        {
            DGUIGHFData.Update<patientsattachmentstypes, DoctcoDModel>(_doctcodModel.PatientsAttachmentsTypes, item);
        }
        ...
        {
            DGUIGHFData.Remove<patientsattachmentstypes, DoctcoDModel>(_doctcodModel.PatientsAttachmentsTypes, item);
        }
