    ...
    public partial class FormTreatmentsPricesLists : DGUIGHFForm
    {
        ...
        private object GetDataSource_main()
        {
            IEnumerable<VTreatmentsPricesLists> vTreatmentsPricesLists =
                _doctcodModel.TreatmentsPricesLists.List().Select(
        ...
        {
            return DGUIGHFData.LoadEntityFromCurrentBindingSource<treatmentspriceslists, DoctcoDModel>(_doctcodModel.TreatmentsPricesLists, vTreatmentsPricesListsBindingSource, new string[] { "treatmentspriceslists_id" });
        }
        ...
        {
            DGUIGHFData.SetBindingSourcePosition<treatmentspriceslists, DoctcoDModel>(_doctcodModel.TreatmentsPricesLists, item, vTreatmentsPricesListsBindingSource);
        }
        ...
        {
            DGUIGHFData.Add<treatmentspriceslists, DoctcoDModel>(_doctcodModel.TreatmentsPricesLists, item);
        }
        ...
        {
            DGUIGHFData.Update<treatmentspriceslists, DoctcoDModel>(_doctcodModel.TreatmentsPricesLists, item);
        }
        ...
        {
            DGUIGHFData.Remove<treatmentspriceslists, DoctcoDModel>(_doctcodModel.TreatmentsPricesLists, item);
        }
