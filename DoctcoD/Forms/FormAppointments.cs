    ...
    public partial class FormAppointments : DGUIGHFForm
    {
        ...
        private void PreloadView()
        {
            ...
            if (comboBox_filterDoctors.Items.Count == 2)
                comboBox_filterDoctors.SelectedIndex = 1;
            _boxLoader.LoadComboBoxFilterRooms(comboBox_filterRooms);
        ...
        private void LoadAppointments()
        {
            ...
            if (comboBox_filterDoctors.SelectedIndex != -1 && comboBox_filterDoctors.SelectedIndex != 0)
            {
                ...
                if (comboBox_filterRooms.SelectedIndex != -1 && comboBox_filterRooms.SelectedIndex != 0)
                {
                    ...
                    appointments = _doctcodModel.Appointments.List(r =>
            ...
            {
                patients patient = _doctcodModel.Patients.Find(appointment.patients_id);
                ...
                {
                    rooms room = _doctcodModel.Rooms.Find(appointment.rooms_id);
                    if (room != null)
                    {
            ...
            {
                foreach (patientstreatments patientstreatment in _doctcodModel.PatientsTreatments.List(r =>
                ...
                {
                    patients patient = _doctcodModel.Patients.Find(patientstreatment.patients_id);
        ...
        private void button_tabAppointments_save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (_currentEditingMode == EditingMode.C)
                    DGUIGHFData.Add<appointments, DoctcoDModel>(_doctcodModel.Appointments, (appointments)appointmentsBindingSource.Current);
                else if (_currentEditingMode == EditingMode.U)
                    DGUIGHFData.Update<appointments, DoctcoDModel>(_doctcodModel.Appointments, (appointments)appointmentsBindingSource.Current);
                else if (_currentEditingMode == EditingMode.D)
                    DGUIGHFData.Remove<appointments, DoctcoDModel>(_doctcodModel.Appointments, (appointments)appointmentsBindingSource.Current);
            }
        ...
        private void button_tabAppointments_openpatient_Click(object sender, EventArgs e)
        {
            ...
            {
                patients patient = _doctcodModel.Patients.Find(_selectedPatientId);
                if (patient != null)
                {
        ...
        private void calendar_listdays_ItemClick(object sender, CalendarItemEventArgs e)
        {
            ...
            else
            {
                ...
                if (appointments_id != -1)
                {
                    ...
                    appointmentsBindingSource.DataSource = _doctcodModel.Appointments.Find(appointments_id);
                    appointments appointment = _doctcodModel.Appointments.Find(appointments_id);
