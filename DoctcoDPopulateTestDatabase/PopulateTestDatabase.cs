...
EXEC sp_msforeachtable 'DBCC CHECKIDENT(''?'', RESEED, 0)'; DECLARE @max int; SELECT @max = MAX(reports_id) from reports; DBCC CHECKIDENT('reports', RESEED, @max);"
        ...
        public void Populate()
        {
            ...
            int descriptiontemplatestreatmentsNum = 5;
            int roomsNum = 3;
            ...
            _doctcodModel.AddressesTypes.Add(addressestypesHome);
            ...
            _doctcodModel.ContactsTypes.Add(contactstypesMobile);
            ...
            for (int i = 0; i < medicalrecordstypesNum; i++)
            {
                ...
                _doctcodModel.MedicalrecordsTypes.Add(medicalrecordstypestmp);
                medicalrecordstypes = medicalrecordstypes.Concat(new medicalrecordstypes[] { medicalrecordstypestmp }).ToArray();
            }

            Console.WriteLine("Add DescriptiontemplatesTreatments...");
            for (int i = 0; i < descriptiontemplatestreatmentsNum; i++)
            {
                descriptiontemplatestreatments descriptiontemplatestreatmentstmp = new descriptiontemplatestreatments()
                {
                    descriptiontemplatestreatments_name = "DescriptiontemplatesTreatments " + (i + 1),
                    descriptiontemplatestreatments_template = BuildRandomString(_r.Next(50, 100))
                };
                _doctcodModel.DescriptiontemplatesTreatments.Add(descriptiontemplatestreatmentstmp);
            }
            ...
            _doctcodModel.Taxes.Add(taxesT22);
            taxes taxesT04 = new taxes()
            {
                taxes_name = "Tax 4%",
                taxes_rate = 4
            };
            _doctcodModel.Taxes.Add(taxesT04);
            ...
            _doctcodModel.TaxesDeductions.Add(taxesdeductionsTD1);

            Console.WriteLine("Add ComputedLines...");
            _doctcodModel.ComputedLines.Add(new computedlines()
            {
            ...
            _doctcodModel.Doctors.Add(doctorsTest);
            ...
            for (int i = 0; i < roomsNum; i++)
            {
                ...
                _doctcodModel.Rooms.Add(roomstmp);
            ...
            _doctcodModel.InvoicesFooters.Add(invoicesfooters01);
            ...
            _doctcodModel.EstimatesFooters.Add(estimatesfooters01);
            ...
            _doctcodModel.PaymentsTypes.Add(paymentstypesCash);
            ...
            for (int i = 0; i < patientsattachmentstypesNum; i++)
            {
                ...
                _doctcodModel.PatientsAttachmentsTypes.Add(patientsattachmentstypestmp);
            ...
            _doctcodModel.PatientsAttributesTypes.Add(patientsattributestypesAge);
            ...
            for (int i = 0; i < treatmentstypesNum; i++)
            {
                ...
                _doctcodModel.TreatmentsTypes.Add(treatmentstypestmp);
            ...
            for (int i = 0; i < treatmentspriceslistsNum; i++)
            {
                ...
                _doctcodModel.TreatmentsPricesLists.Add(treatmentspricesliststmp);
            ...
            for (int i = 0; i < treatmentsNum; i++)
            {
                ...
                _doctcodModel.Treatments.Add(treatmentstmp);
            ...
            foreach (treatments treatment in treatments)
            {
                if (_r.Next(0, 100) >= 30)
                {
                    ...
                    _doctcodModel.TreatmentsPrices.Add(treatmentspricestmp);
            ...
            for (int i = 0; i < _patientsNum; i++)
            {
                ...
                _doctcodModel.Patients.Add(patientstmp);
            ...
            foreach (patients patient in patients)
            {
                do
                {
                    _doctcodModel.PatientsAddresses.Add(new patientsaddresses()
                    {
            ...
            foreach (patients patient in patients)
            {
                do
                {
                    _doctcodModel.PatientsAttributes.Add(new patientsattributes()
                    {
                        patients_id = patient.patients_id,
            ...
            foreach (patients patient in patients)
            {
                do
                {
                    _doctcodModel.PatientsContacts.Add(new patientscontacts()
                    {
                        patients_id = patient.patients_id,
            ...
            foreach (patients patient in patients)
            {
                do
                {
                    _doctcodModel.PatientsMedicalrecords.Add(new patientsmedicalrecords()
                    {
                        patients_id = patient.patients_id,
            ...
            foreach (patients patient in patients)
            {
                if (_r.Next(0, 100) > 50)
                {
                    do
                    {
                        ...
                        _doctcodModel.PatientsAttachments.Add(new patientsattachments()
                        {
                            patients_id = patient.patients_id,
            ...
            foreach (patientstreatments patientstreatment in _doctcodModel.PatientsTreatments.List())
            {
                if (patientstreatment.patientstreatments_fulfilldate != null)
                {
                    ...
                    {
                        int quantity = 1;
                        _doctcodModel.Payments.Add(new payments()
                        {
            ...
            foreach (patients patient in patients)
            {
                do
                {
                    ...
                    {
                        estimates_date = date,
                        estimates_number = (_doctcodModel.Estimates.List(r => r.estimates_date.Year == date.Year).Count + 1).ToString(),
                        doctors_id = doctorsTest.doctors_id,
                        patients_id = patient.patients_id,
                    ...
                    _doctcodModel.Estimates.Add(estimate);
                    ...
                    do
                    {
                        ...
                        _doctcodModel.EstimatesLines.Add(new estimateslines()
                        {
            ...
            foreach (patients patient in patients)
            {
                do
                {
                    ...
                    {
                        invoices_date = date,
                        invoices_number = (_doctcodModel.Invoices.List(r => r.invoices_date.Year == date.Year).Count + 1).ToString(),
                        doctors_id = doctorsTest.doctors_id,
                        patients_id = patient.patients_id,
                    ...
                    do
                    {
                        ...
                        _doctcodModel.InvoicesLines.Add(new invoiceslines()
                        {
