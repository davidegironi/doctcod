...
namespace DG.DoctcoD
{
    ...
    public class DoctcoDPrintModel : IDoctcoDPrintModel
    {
        ...
        /// </summary>
        private const string languageFilenamePrefix = "DoctcoDPrintModel01-";

        /// <summary>
        /// Default settings file
        /// </summary>
        private const string settingsFilename = "DoctcoDPrintModel01.json";
        ...
        public bool BuildEstimate(DoctcoDModel doctcodModel, int estimates_id, string language, string filename, ref string[] errors)
        {
            ...
            try
            {
                ...
                if (estimate.invoices_id != null)
                    invoice = doctcodModel.Invoices.Find((int)estimate.invoices_id);
